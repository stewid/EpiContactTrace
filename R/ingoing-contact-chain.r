...
##'   }
##' }
##' @references Noremark, M., et al., Network analysis of cattle and pig
##' movements in Sweden: Measures relevant for disease control and riskbased
##' surveillance.  (2011), Preventive Veterinary Medicine doi:
